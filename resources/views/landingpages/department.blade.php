...
<section id="department" class='department'>
  <div class='container'>
    <div class="row">
      <div class="col-md-6">
        <div class="department-icon py-5 departmentIcon">
          <div class='imageContainer'>
            <img class='img-icon' src="/imges/icones_department/dental_aesthetic_smile.png" alt="Dental Aesthetics" />
          </div>
      ...
      <div class="col-md-6">
        <div class='department-icon py-5 departmentIcon'>
          ...
          <div class='imageContainer'>
            <img class='img-icon' src="/imges/icones_department/tooth_health.png" alt="Dental Treatments" />
          </div>
          <p class='departmentIconP'>
            Dental Treatments
          </p>
